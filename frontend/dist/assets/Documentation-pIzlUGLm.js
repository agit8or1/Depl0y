import{k as q,s as c,c as p,f as t,H as Q,M as j,e as A,F as D,j as N,t as y,i as B,n as _,x as v,w as k,g as i,G as z,Q as X,J as f,E as K}from"./vendor-vue-74A1W2vP.js";import{_ as W,b as Z}from"./index-DwVhOxro.js";import{u as J}from"./vendor-toast-CvgraQc6.js";import"./vendor-axios-BV-dCbsu.js";function l(d,e=""){const m="cb-"+Math.random().toString(36).slice(2,8);return`<div class="code-block-wrap"><pre class="code-block" id="${m}">${d}</pre><button class="copy-btn" onclick="navigator.clipboard.writeText(document.getElementById('${m}').innerText).then(()=>{this.textContent='Copied!';setTimeout(()=>this.textContent='Copy',1500)})">Copy</button></div>`}function x(d){return`<div class="info-box">${d}</div>`}function R(d){return`<div class="warn-box">${d}</div>`}function Y(d){return`<div class="tip-box">${d}</div>`}function n(d,e,m){return`<div class="doc-step"><span class="step-num">${d}</span><div class="step-body"><strong>${e}</strong>${m}</div></div>`}function a(d,e){return`<div class="tab-item"><strong>${d}</strong><span>${e}</span></div>`}const ee=[{id:"getting-started",icon:"&#9654;",title:"Getting Started",html:`
