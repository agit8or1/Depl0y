...
export default {
  ...
  idrac: {
    ...
    clearNodeSel: (id) => api.post(`/idrac/node/${id}/clear-sel`),
    clearStandaloneSel: (id) => api.post(`/idrac/standalone/${id}/clear-sel`),
    clearHostSel: (id) => api.post(`/idrac/${id}/clear-sel`),
    ...
    getNodeProcessors: (id) => api.get(`/idrac/node/${id}/processors`),
    getNodeMemory: (id) => api.get(`/idrac/node/${id}/memory`),
    getNodeStorage: (id) => api.get(`/idrac/node/${id}/storage`),
    getNodeFirmware: (id) => api.get(`/idrac/node/${id}/firmware`),
    getNodeSensors: (id) => api.get(`/idrac/node/${id}/sensors`),
    testNodeSsh: (id) => api.get(`/idrac/node/${id}/ssh/test`),
    getNodeSshHardware: (id) => api.get(`/idrac/node/${id}/ssh/hardware`),
    getNodeSshNetwork: (id) => api.get(`/idrac/node/${id}/ssh/network`),
    getNodeSshFirmware: (id) => api.get(`/idrac/node/${id}/ssh/firmware`),
    getNodeSshLogs: (id, limit = 100) => api.get(`/idrac/node/${id}/ssh/logs`, { params: { limit } }),
    runNodeSshUpdate: (id) => api.post(`/idrac/node/${id}/ssh/update`),
  },
  ...
  pbs: {
    ...
    clearIdracSel: (id) => api.post(`/pbs/${id}/idrac/clear-sel`),
