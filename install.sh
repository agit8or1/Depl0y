...
if [ "$UPGRADE_MODE" = true ]; then
    ...
    echo "╚══════════════════════════════════════════════════════════╝"
    echo ""
    echo "🎉 Depl0y v1.3.3 has been successfully upgraded!"
    echo ""
    echo "📍 Access Depl0y at:"
    echo "   http://$IP"
    echo ""
    echo "✨ What's new in v1.3.3:"
    echo "   • Debian 12 support - Fixed critical Python 3.11 compatibility issues"
    echo "   • Updated installer package with all fixes included"
    ...
    echo "╚══════════════════════════════════════════════════════════╝"
    echo ""
    echo "🎉 Depl0y v1.3.3 has been successfully installed!"
    echo ""
    echo "📍 Access Depl0y at:"
    echo "   http://$IP"
    echo ""
