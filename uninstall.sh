...
if [[ "$1" == "-y" || "$1" == "--yes" ]]; then
    ...
    echo "  curl -fsSL https://deploy.agit8or.net/downloads/uninstall.sh | sudo bash -s -- -y"
    echo ""
    echo "Or download and run locally:"
    echo "  curl -fsSL https://deploy.agit8or.net/downloads/uninstall.sh -o uninstall.sh"
...
echo "  curl -fsSL https://deploy.agit8or.net/downloads/install.sh | sudo bash"
echo ""
