...
- **✅ Fixed Cloud Image Enable** - Resolved sshpass installation error
- **🔧 Sudo Permissions** - Fixed DEBIAN_FRONTEND environment variable error
- **⚙️ Updated Sudoers** - Added missing systemctl and journalctl permissions
