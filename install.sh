...
if [ "$UPGRADE_MODE" = true ]; then
    ...
    echo "╚══════════════════════════════════════════════════════════╝"
    echo ""
    echo "🎉 Depl0y v1.3.6 has been successfully upgraded!"
    echo ""
    echo "📍 Access Depl0y at:"
    echo "   http://$IP"
    echo ""
    echo "✨ What's new in v1.3.6:"
    echo "   • Fixed cloud image enable - sshpass installation now works"
    echo "   • Resolved DEBIAN_FRONTEND sudo error"
    echo "   • Updated sudoers permissions for proper functionality"
    echo ""
    if [ "$RESET_PASSWORD" = true ]; then
        echo "🔐 Password Reset:"
    ...
    echo "╚══════════════════════════════════════════════════════════╝"
    echo ""
    echo "🎉 Depl0y v1.3.6 has been successfully installed!"
    echo ""
    echo "📍 Access Depl0y at:"
    echo "   http://$IP"
    echo ""
