        ...
        "meme-maker": [
            {
                ...
                "name": "Meme Maker v1",
                "category": "image",
                "description": "DreamShaper 8 for textless image generation + Qwen 2.5 7B for structured caption JSON. Split pipeline: LLM captions only, image model never renders text, Pillow overlays result. GPU optional.",
                "size_gb": 7.5,
                "min_ram_gb": 16,
                "recommended_ram_gb": 24,
                "min_vram_gb": 4,
